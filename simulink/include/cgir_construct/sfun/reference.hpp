...
namespace RTW {
extern "C" typedef int (*PfnAssign)(const SFun_Reference_Impl*, const SFun_Value_Impl*);
...
inline Reference Reference::operator[](const Value& index) const {
    SFun_Reference_Impl* pResult = SFun_Reference_op_subscript_V(fpImpl, index.getImpl());
    return Reference(pResult);
}

inline Reference Reference::operator[](const Constant& index) const {
    SFun_Reference_Impl* pResult = SFun_Reference_op_subscript_C(fpImpl, index.getImpl());
    return Reference(pResult);
}
