...
CGIR_CONSTRUCT_API SFun_Reference_Impl* SFun_Block_createLocal_T_c(SFun_CodeCtor_Impl* pThis,
                                                                   const SFun_Type_Impl* pType,
                                                                   const char* name);

CGIR_CONSTRUCT_API SFun_Value_Impl* SFun_Block_input_i(SFun_CodeCtor_Impl* pThis, int index);

CGIR_CONSTRUCT_API SFun_Reference_Impl* SFun_Block_output_i(SFun_CodeCtor_Impl* pThis, int index);

CGIR_CONSTRUCT_API int SFun_CodeCtor_numInputs(int* pResult, const SFun_CodeCtor_Impl* pThis);

CGIR_CONSTRUCT_API int SFun_CodeCtor_numOutputs(int* pResult, const SFun_CodeCtor_Impl* pThis);
}
}
