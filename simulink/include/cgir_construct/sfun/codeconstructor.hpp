...
inline Reference CodeConstructor::createLocal(const Type& dataType, const char* name) {
    SFun_Reference_Impl* pResult = SFun_Block_createLocal_T_c(fpImpl, dataType.getImpl(), name);
