...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_get_ml_var_no_error(const char* variableName,
                                                              MatlabWorkspaceType workspaceType);
LIBMWSF_RUNTIME_API const mxArray* sf_mex_get_ml_var(const char* variableName,
                                                     MatlabWorkspaceType workspaceType);
...
LIBMWSF_RUNTIME_API void checkStringBufferOverflowDiagnostic(int diagnosticValue,
                                                             ...
                                                             int offsetSrcLoc,
                                                             int lengthSrcLoc);
LIBMWSF_RUNTIME_API void stringFcnNumericArgumentDiagnostic(SimStruct* S,
                                                            int limit,
                                                            int argIndex,
                                                            unsigned int ssid,
                                                            int offsetSrcLoc,
...
LIBMWSF_RUNTIME_API int sf_mex_call_matlab(int nlhs,
                                           mxArray* plhs[],
                                           int nrhs,
                                           mxArray* prhs[],
                                           const char* fcnName);
