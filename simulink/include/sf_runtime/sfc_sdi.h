...
LIBMWSF_RUNTIME_API void sdi_database_initialize(struct sdiBlockID* blockId,
                                                 ...
                                                 uint8_T* loggedStatesBuffer,
                                                 int numStates,
                                                 unsigned int* dataSSIDs,
                                                 uint8_T* loggedDataBuffer,
                                                 int numData);

LIBMWSF_RUNTIME_API void sdi_database_terminate(struct sdiBlockID* blockId);

LIBMWSF_RUNTIME_API void sdi_register_self_activity_signal(struct sdiBlockID* blockId,
...
LIBMWSF_RUNTIME_API void sdi_register_child_activity_signal(struct sdiBlockID* blockId,
                                                            const char* targetName,
...
LIBMWSF_RUNTIME_API void sdi_register_leaf_activity_signal(struct sdiBlockID* blockId,
                                                           const char* targetName,
                                                           const char* parentStateRelativePath,
                                                           int numLeafStates,
                                                           const char** stateNames,
...
LIBMWSF_RUNTIME_API void sdi_register_enum_data_type_signal(struct sdiBlockID* blockId,
                                                            const char* targetName,
                                                            const char* parentStateRelativePath,
...
LIBMWSF_RUNTIME_API void sdi_register_string_data_type_signal(struct sdiBlockID* blockId,
                                                              const char* targetName,
                                                              const char* parentStateRelativePath,
                                                              int numDims,
                                                              int* dims,
...
LIBMWSF_RUNTIME_API void sdi_register_half_type_signal(struct sdiBlockID* blockId,
                                                       const char* targetName,
                                                       const char* parentStateRelativePath,
                                                       int numDims,
                                                       int* dims,
...
LIBMWSF_RUNTIME_API void sdi_register_builtin_data_type_signal(struct sdiBlockID* blockId,
                                                               const char* targetName,
                                                               const char* parentStateRelativePath,
                                                               int numDims,
                                                               int* dims,
...
LIBMWSF_RUNTIME_API void sdi_register_non_virtual_bus_parent(struct sdiBlockID* blockId,
                                                             unsigned int ssId,
                                                             unsigned int busIdx,
...
LIBMWSF_RUNTIME_API void sdi_register_non_virtual_bus_built_in_type_leaf(struct sdiBlockID* blockId,
                                                                         int uMethod,
                                                                         unsigned int ssId,
                                                                         unsigned int parentsIdx,
                                                                         const char* targetName,
...
LIBMWSF_RUNTIME_API void sdi_register_non_virtual_bus_half_type_leaf(struct sdiBlockID* blockId,
                                                                     int uMethod,
                                                                     unsigned int ssId,
                                                                     unsigned int parentsIdx,
                                                                     const char* targetName,
...
LIBMWSF_RUNTIME_API void sdi_register_non_virtual_bus(struct sdiBlockID* blockId,
                                                      void* busAddr,
                                                      int uMethod,
                                                      const char* targetName,
                                                      const char* parentStateRelativePath,
...
LIBMWSF_RUNTIME_API void sdi_register_base_address(struct sdiBlockID* blockId,
                                                   void* baseAddr,
                                                   unsigned int ssId);
...
LIBMWSF_RUNTIME_API void sdi_stream_child_activity_signal(struct sdiBlockID* blockId,
                                                          unsigned int ssId,
                                                          void* data);
LIBMWSF_RUNTIME_API void sdi_stream_data_signal(struct sdiBlockID* blockId,
                                                unsigned int ssId,
                                                void* data);
LIBMWSF_RUNTIME_API void sdi_stream_bus_element(struct sdiBlockID* blockId,
                                                unsigned int ssId,
                                                const char* elementExpr,
                                                void* elementData);
LIBMWSF_RUNTIME_API void sdi_update_self_activity_signal(struct sdiBlockID* blockId,
                                                         unsigned int ssId,
                                                         int value);
LIBMWSF_RUNTIME_API void sdi_update_leaf_activity_signal(struct sdiBlockID* blockId,
                                                         unsigned int ssId,
                                                         int value);
