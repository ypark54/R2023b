...
LIBMWSF_RUNTIME_API void slTestInitialize(struct slTestBlkInfo* blkInfo,
                                          slTestResult* current,
                                          slTestResult* final,
                                          double* finalResultTimes,
                                          int count);
...
LIBMWSF_RUNTIME_API void slTestEvalOnFail(struct slTestBlkInfo* blkInfo,
                                          int idx,
                                          double currentTime,
                                          mxClassID fmtStrArgTypes[],
                                          void* fmtData[]);
