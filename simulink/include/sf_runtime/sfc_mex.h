...
typedef struct emlrtRTEInfo emlrtMCInfo;
typedef struct emlrtMsgIdentifier emlrtMsgIdentifier;
...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_evalin(MatlabWorkspaceType workspaceType,
                                                 unsigned int numReturn,
                                                 const char* evalFormatStr,
                                                 ...);

LIBMWSF_RUNTIME_API const mxArray* sf_mex_call(emlrtConstCTX aTLS,
                                               emlrtMCInfo* aLoc,
...
LIBMWSF_RUNTIME_API void sf_mex_error_direct_call(SimStruct* s,
                                                  const char* fcnName,
                                                  const char* fileName);
LIBMWSF_RUNTIME_API void sf_mex_ignore_message(const char* msg, ...);
LIBMWSF_RUNTIME_API void sf_assertion_failed(const char* expr,
                                             const char* in_file,
                                             int at_line,
                                             const char* msg);
...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_getfield(
...
LIBMWSF_RUNTIME_API void sf_mex_setfieldbynum(const mxArray* mxStruct,
                                              ...
                                              const mxArray* value,
                                              int fieldIdx);
LIBMWSF_RUNTIME_API const mxArray* sf_mex_addfield(
    const mxArray* mxStruct,
    const mxArray* mxField, 
    const char* fldName,    
    const char* errName,    
    int index);             
LIBMWSF_RUNTIME_API const mxArray* sf_mex_createfield(
    const mxArray* mxStruct,
    const char* fldName,    
    const char* errName);   
LIBMWSF_RUNTIME_API void sf_mex_check_struct(const emlrtMsgIdentifier* aMsgId,
                                             const mxArray* s,
                                             int32_T nFields,
                                             const char** fldNames,
                                             uint32_T nDims,
                                             const void* pDims);
LIBMWSF_RUNTIME_API void sf_mex_check_struct_vs(
    const emlrtMsgIdentifier* aMsgId,
    const mxArray* aSrcMx,
    int32_T aNFields,
    const char** aFldNames,
    uint32_T aNumDims,   
    boolean_T* aDynamic, 
    const void* aDimsMax,
    void* aDimsActual);  
LIBMWSF_RUNTIME_API void sf_mex_check_bus_parameter(const mxArray* mxStruct,
                                                    int32_T nDims,
                                                    void* matrixSizes,
                                                    int32_T nFields,
...
LIBMWSF_RUNTIME_API void sf_mex_check_cell(const emlrtMsgIdentifier* aMsgId,
                                           const mxArray* s,
                                           uint32_T nDims,
                                           const void* pDims,
                                           const boolean_T* aDynamic);
LIBMWSF_RUNTIME_API void sf_mex_check_cell_vs(const emlrtMsgIdentifier* aMsgId,
                                              const mxArray* s,
                                              uint32_T nDims,
                                              const void* pDims,
                                              const boolean_T* aDynamic,
                                              int32_T* aOutSizes);
LIBMWSF_RUNTIME_API void sf_mex_check_cell_with_unassigned_base(const emlrtMsgIdentifier* aMsgId,
                                                                const mxArray* s);
LIBMWSF_RUNTIME_API void sf_mex_check_mcos_class(const emlrtMsgIdentifier* aMsgId,
                                                 const mxArray* s,
                                                 const char* aClassName);
LIBMWSF_RUNTIME_API void sf_mex_check_ct_mxarray(const emlrtMsgIdentifier* aMsgId,
                                                 const mxArray* r,
                                                 const mxArray* c);
LIBMWSF_RUNTIME_API mxArray* sf_mex_create_class_instance(const char* aClassName);
LIBMWSF_RUNTIME_API void sf_mex_set_all_properties(const mxArray** s,
                                                   int32_T aIndex,
                                                   int32_T aPropCount,
                                                   const char** aPropNames,
                                                   const char** aPropClasses,
                                                   const mxArray** aPropValues);
LIBMWSF_RUNTIME_API void sf_mex_get_all_properties(const mxArray* s,
                                                   int32_T aIndex,
                                                   int32_T aPropCount,
                                                   const char** aPropNames,
                                                   const char** aPropClasses,
                                                   const mxArray** aPropValues);
LIBMWSF_RUNTIME_API const mxArray* sf_mex_convert_to_redirect_target(const mxArray* s,
                                                                     int32_T aIndex,
                                                                     const char* aClassName);
LIBMWSF_RUNTIME_API const mxArray* sf_mex_convert_to_redirect_source(const mxArray* s,
                                                                     int32_T aIndex,
                                                                     const char* aClassName);
LIBMWSF_RUNTIME_API bool sf_mex_check_fi(const emlrtMsgIdentifier* aMsgId,
                                         const mxArray* fi,
                                         boolean_T complex,
                                         uint32_T nDims,
                                         const void* vDims,
                                         const mxArray* fimath,
                                         const mxArray* numericType);
LIBMWSF_RUNTIME_API void sf_mex_check_fi_vs(
    const emlrtMsgIdentifier* aMsgId,
    const mxArray* aSrcFI,
    boolean_T aComplex,
    uint32_T aNumDims,        
    const boolean_T* aDynamic,
    const void* aDimsMax,     
...
LIBMWSF_RUNTIME_API void sf_mex_check_builtin(const emlrtMsgIdentifier* aMsgId,
                                              const mxArray* mx,
                                              const char* clsName,
                                              boolean_T complex,
                                              uint32_T nDims,
...
LIBMWSF_RUNTIME_API void sf_mex_check_builtin_vs(const emlrtMsgIdentifier* aMsgId,
                                                 const mxArray* mx,
                                                 const char* clsName,
                                                 boolean_T complex,
                                                 uint32_T nDims,
...
LIBMWSF_RUNTIME_API void sf_mex_check_enum(const char* enumName,
                                           int numFields,
                                           const char** elNames,
                                           const int32_T* elValues);
LIBMWSF_RUNTIME_API const mxArray* sf_mex_create_sparse(void* d,
                                                        int32_T* colidx,
                                                        int32_T* rowidx,
                                                        int32_T m,
                                                        int32_T n,
                                                        ...
                                                        int32_T aClassId,
                                                        int32_T aComplexity);
LIBMWSF_RUNTIME_API void sf_mex_check_sparse(emlrtMsgIdentifier* aMsgId,
                                             mxArray* pa,
                                             int32_T* pDims,
                                             boolean_T* aDynamic,
                                             int32_T aClassId,
...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_create_enum(const char* enumName,
                                                      const mxArray* mxValues);
LIBMWSF_RUNTIME_API int32_T sf_mex_get_enum_element(const mxArray* mxValues, int index);

LIBMWSF_RUNTIME_API const mxArray* sf_mex_createstruct(
    const char* nameStr,    
    int numFields,          
    const char** fieldNames,
    int numDims,            
    ...);                   
LIBMWSF_RUNTIME_API const mxArray* sf_mex_createstructarray(
    const char* aNameStr,
    int aNumDims,        
    const int* aDims,    
    int numFields,
...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_create_from_dynamic_string(
    ...
    int numDims,              
    ...);                     
LIBMWSF_RUNTIME_API const mxArray* sf_mex_create(
    const char* nameStr,      
    const void* dataPtr,      
    int dataType,             
    unsigned int isComplex,   
...
LIBMWSF_RUNTIME_API void sf_mex_setfield(const mxArray* structArray,
                                         int index,
                                         const char* fieldName,
                                         const mxArray* value);
...
LIBMWSF_RUNTIME_API void sf_mex_export(const char* vectName,
                                       ...
                                       MatlabWorkspaceType workspaceType);
LIBMWSF_RUNTIME_API void sf_mex_import(
    const emlrtMsgIdentifier* aMsgId,
    const mxArray* mxArrayPtr,       
    void* dataPtr,                   
    int isStrict,                    
    ...
    int numDims,                     
    ...);                            
LIBMWSF_RUNTIME_API void sf_mex_import_named(
    const char* nameStr,      
    const mxArray* mxArrayPtr,
    void* dataPtr,            
    int isStrict,             
    ...
    int numDims,              
    ...);                     
LIBMWSF_RUNTIME_API void sf_mex_import_dynamic_string(
    const char* nameStr,  
    const mxArray* aSrcMx,
    void** aDstData);     

LIBMWSF_RUNTIME_API void sf_mex_import_vs(
    const emlrtMsgIdentifier* aMsgId,
    const mxArray* aSrcMx,           
    void* aDstData,                  
    int aStrict,                     
    ...
    const void* aDimsMax,            
    void* aDimsActual);              
LIBMWSF_RUNTIME_API void sf_mex_import_vs_named(
    const char* nameStr,      
    const mxArray* aSrcMx,    
    void* aDstData,           
    int aStrict,              
...
LIBMWSF_RUNTIME_API int64_T sf_mex_lw_bounds_check_int64(int64_T indexValue,
                                                         int firstIndex,
                                                         int lastIndex);
#endif
...
LIBMWSF_RUNTIME_API void sf_mex_lw_impx_size_check_nd(const int* dims1,
                                                      const int* dims2,
                                                      int nDims);
...
LIBMWSF_RUNTIME_API void sf_mex_lw_sub_assign_size_check_nd(const int* dims1,
                                                            int nDims1,
                                                            const int* dims2,
                                                            int nDims2);
LIBMWSF_RUNTIME_API void sf_mex_lw_for_loop_vector_check(double start,
                                                         double step,
                                                         double end,
                                                         mxClassID classID,
                                                         int n);
...
#define EML_FOR_LOOP_SINGLE_NUMEL_ROUNDOFF                                                         \
    "Loop range with length %g cannot be represented exactly by index variable of 'single' type. " \
    "Rounding of index value might produce unexpected results. Use index variable of type double " \
    "or integer."

#define sf_assertion(expr) ((expr) ? (void)0 : sf_assertion_failed(#expr, __FILE__, __LINE__, NULL))
#define sf_assertion_msg(expr, msg) \
    ((expr) ? (void)0 : sf_assertion_failed(#expr, __FILE__, __LINE__, msg))
...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_emlrtCoerceToClass(const mxArray* mxArrayPtr,
                                                             const char* clsName);
...
LIBMWSF_RUNTIME_API void ssReadFromDataStore_wrapper(SimStruct* S,
                                                     int dsmIndex,
                                                     const char* dsmName);
LIBMWSF_RUNTIME_API void ssReadFromDataStoreElement_wrapper(SimStruct* S,
                                                            int dsmIndex,
                                                            const char* dsmName,
                                                            int elementIndex);
LIBMWSF_RUNTIME_API void ssWriteToDataStore_wrapper(SimStruct* S,
                                                    int dsmIndex,
                                                    const char* dsmName);
LIBMWSF_RUNTIME_API void ssWriteToDataStoreAndLogToDI_wrapper(SimStruct* S,
                                                              int dsmIndex,
                                                              const char* dsmName);
LIBMWSF_RUNTIME_API void ssWriteToDataStoreElement_wrapper(SimStruct* S,
                                                           int dsmIndex,
                                                           const char* dsmName,
                                                           int ElementIndex);
LIBMWSF_RUNTIME_API bool ssGetDSMBlockDiagnosticsEnabled_wrapper(SimStruct* S,
                                                                 int dsmIdx,
                                                                 const char* dsmName);

LIBMWSF_RUNTIME_API void ssMemRegionCreateDescriptor_wrapper(
    SimStruct* S,
    int numSubMemRegions,
    SFcnMemRegionInfo** memRegionDescriptor);
LIBMWSF_RUNTIME_API void ssMemRegionSetFlatSubElement_wrapper(
    SimStruct* S,
    SFcnMemRegionInfo* memRegionDescriptor,
    int subRegionIdx,
    int busElementIdx,
    int numFlatIdx,
    int* flatIdxs);
LIBMWSF_RUNTIME_API void ssReadFromDataStoreRegion_wrapper(SimStruct* S,
                                                           int dsmIdx,
                                                           void* dataAddr,
                                                           SFcnMemRegionInfo* dsmRegionDescriptor);
LIBMWSF_RUNTIME_API void ssWriteToDataStoreRegion_wrapper(SimStruct* S,
                                                          int dsmIdx,
                                                          void* dataAddr,
                                                          SFcnMemRegionInfo* dsmRegionDescriptor);
LIBMWSF_RUNTIME_API void ssMemRegionDestroyDescriptor_wrapper(
    SimStruct* S,
    SFcnMemRegionInfo** memRegionDescriptor);
...
LIBMWSF_RUNTIME_API int* ssGetCurrentInputPortDimensions_wrapper(SimStruct* S, int portNumber);
LIBMWSF_RUNTIME_API int* ssGetCurrentOutputPortDimensions_wrapper(SimStruct* S, int portNumber);
LIBMWSF_RUNTIME_API void ssSetCurrentOutputPortDimensions_wrapper(SimStruct* S,
                                                                  int pIdx,
                                                                  int dIdx,
                                                                  int val);
...
LIBMWSF_RUNTIME_API ssMessage
ssMessageQueuePop_wrapper(SimStruct* S, int qType, int queueID, bool isDesChart, bool isMsgTrigger);
LIBMWSF_RUNTIME_API void ssMessageSend_wrapper(SimStruct* S,
                                               int outputPortNum,
                                               void* payload,
                                               unsigned int priority);
LIBMWSF_RUNTIME_API void ssMessageSendLocal_wrapper(SimStruct* S,
                                                    int queueId,
                                                    void* payload,
                                                    unsigned int priority);
...
LIBMWSF_RUNTIME_API void ssMessageRelay_wrapper(SimStruct* S,
                                                int queueType,
                                                int pIdx,
                                                ssMessage msgObj);
LIBMWSF_RUNTIME_API bool ssIsMessageQueueFull_wrapper(SimStruct* S,
                                                      int queueType,
                                                      int portIdx,
                                                      int isOutputPort);
...
LIBMWSF_RUNTIME_API mxArray* mxCreateStructMatrix_wrapper(int numRows,
                                                          int numCols,
                                                          int numFields,
                                                          const char** fieldNames);
