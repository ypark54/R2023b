...
# define _SS_SNPRINTF_1(msgToWriteTo, size, fmtStr, arg1) \
    snprintf(msgToWriteTo, size, fmtStr, arg1)
# define _SS_SNPRINTF_2(msgToWriteTo, size, fmtStr, arg1, arg2) \
    snprintf(msgToWriteTo, size, fmtStr, arg1, arg2)
# define _SS_SNPRINTF_3(msgToWriteTo, size, fmtStr, arg1, arg2, arg3) \
    snprintf(msgToWriteTo, size, fmtStr, arg1, arg2, arg3)
# define _SS_SNPRINTF_4(msgToWriteTo, size, fmtStr, arg1, arg2, arg3, arg4) \
    snprintf(msgToWriteTo, size, fmtStr, arg1, arg2, arg3, arg4)
# define _SS_SNPRINTF_5(msgToWriteTo, size, fmtStr, arg1, arg2, arg3, arg4, arg5) \
    snprintf(msgToWriteTo, size, fmtStr, arg1, arg2, arg3, arg4, arg5)
# define _SS_SNPRINTF_6(msgToWriteTo, size, fmtStr, arg1, arg2, arg3, arg4, arg5, arg6) \
    snprintf(msgToWriteTo, size, fmtStr, arg1, arg2, arg3, arg4, arg5, arg6)
#else
# define _SS_SNPRINTF_1(msgToWriteTo, size, fmtStr, arg1) \
    sprintf(msgToWriteTo, fmtStr, arg1)
# define _SS_SNPRINTF_2(msgToWriteTo, size, fmtStr, arg1, arg2) \
    sprintf(msgToWriteTo, fmtStr, arg1, arg2)
# define _SS_SNPRINTF_3(msgToWriteTo, size, fmtStr, arg1, arg2, arg3) \
    sprintf(msgToWriteTo, fmtStr, arg1, arg2, arg3)
# define _SS_SNPRINTF_4(msgToWriteTo, size, fmtStr, arg1, arg2, arg3, arg4) \
    sprintf(msgToWriteTo, fmtStr, arg1, arg2, arg3, arg4)
# define _SS_SNPRINTF_5(msgToWriteTo, size, fmtStr, arg1, arg2, arg3, arg4, arg5) \
    sprintf(msgToWriteTo, fmtStr, arg1, arg2, arg3, arg4, arg5)
# define _SS_SNPRINTF_6(msgToWriteTo, size, fmtStr, arg1, arg2, arg3, arg4, arg5, arg6) \
    sprintf(msgToWriteTo, fmtStr, arg1, arg2, arg3, arg4, arg5, arg6)
#endif
...
void ssWarning(SimStruct *S, const char *msg)
{
    ...
    if (warnMsg == NULL) {
        ...
        (void)_SS_SNPRINTF_2(warnMsg,
                            strlen(msg) + sizeof(fmt)+strlen(ssGetPath(S))+1,
                            fmt,ssGetPath(S), 
                            msg);
                         ...
                         ...)
{
    ...
    (void)_SS_SNPRINTF_1(strBuf,sizeof(strBuf),"Num%sDefines",vectName);
    ...
    for (i = 0; i < nNames; i++) {
        ...
        (void)_SS_SNPRINTF_1(strBuf, sizeof(strBuf), "%sDefine {",vectName);
    ...
    if (nElementsWritten != nElementsExpected) {
        ...
        (void)_SS_SNPRINTF_4(errmsg, SS_ERROR_STATUS_BUFFER_SIZE,
...
#         if S_FUNCTION_LEVEL == 1
          case SS_CALL_MDL_GET_INPUT_PORT_WIDTH:
            if (ssGetmdlGetInputPortWidthLevel1(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlGetInputPortWidth");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_GET_OUTPUT_PORT_WIDTH:
            if (ssGetmdlGetOutputPortWidthLevel1(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlGetOutputPortWidth");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2
          case SS_CALL_MDL_INITIALIZE_PROPAGATION_PASS:
            if (ssGetmdlInitializePropagationPass(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlInitializePropagationPass");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_INPUT_PORT_WIDTH:
            if (ssGetmdlSetInputPortWidth(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetInputPortWidth");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_OUTPUT_PORT_WIDTH:
              if (ssGetmdlSetOutputPortWidth(S) != NULL) {
                  ...
                  (void)_SS_SNPRINTF_1(
                      errmsg, SS_ERROR_STATUS_BUFFER_SIZE,
          ...
          case SS_CALL_MDL_SET_INPUT_PORT_DIMENSION_INFO:
            if (ssGetmdlSetInputPortDimensions(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetInputPortDimensionInfo");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_OUTPUT_PORT_DIMENSION_INFO:
            if (ssGetmdlSetOutputPortDimensions(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetOutputPortDimensionInfo");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_DEFAULT_PORT_DIMENSION_INFO:
            if (ssGetmdlSetDefaultPortDimensions(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetDefaultPortDimensionInfo");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_INPUT_PORT_SYMBOLIC_DIMENSIONS:
            if (ssGetmdlSetInputPortSymbolicDimensions(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetInputPortSymbolicDimensions");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_OUTPUT_PORT_SYMBOLIC_DIMENSIONS:
            if (ssGetmdlSetOutputPortSymbolicDimensions(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetOutputPortSymbolicDimensions");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_INPUT_PORT_SAMPLE_TIME:
            if (ssGetmdlSetInputPortSampleTime(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetInputPortSampleTime");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_OUTPUT_PORT_SAMPLE_TIME:
            if (ssGetmdlSetOutputPortSampleTime(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetOutputPortSampleTime");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_INPUT_PORT_DATA_TYPE:
            if (ssGetmdlSetInputPortDataType(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetInputPortDataType");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_OUTPUT_PORT_DATA_TYPE:
            if (ssGetmdlSetOutputPortDataType(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetOutputPortDataType");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_DEFAULT_PORT_DATA_TYPES:
            if (ssGetmdlSetDefaultPortDataTypes(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetDefaultPortDataTypes");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_INPUT_PORT_COMPLEX_SIGNAL:
            if (ssGetmdlSetInputPortComplexSignal(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetInputPortComplexSignal");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_OUTPUT_PORT_COMPLEX_SIGNAL:
            if (ssGetmdlSetOutputPortComplexSignal(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetOutputPortComplexSignal");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_DEFAULT_PORT_COMPLEX_SIGNALS:
            if (ssGetmdlSetDefaultPortComplexSignals(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetDefaultPortComplexSignals");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
          ...
          case SS_CALL_MDL_SET_INPUT_PORT_FRAME_DATA:
            if (ssGetmdlSetInputPortFrameData(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetInputPortFrameData");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
...
#         endif
          ...
          case SS_CALL_MDL_SET_WORK_WIDTHS:
            if (ssGetmdlSetWorkWidths(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetWorkWidths");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_RTW)
          case SS_CALL_MDL_RTW:
            if (ssGetmdlRTW(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlRTW");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         elif defined(MDL_INITIALIZE_CONDITIONS)
          case SS_CALL_MDL_INITIALIZE_CONDITIONS:
            if (ssGetmdlInitializeConditions(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlInitializeConditions");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_START)
          case SS_CALL_MDL_START:
            if (ssGetmdlStart(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlStart");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_COPY_RTP_DATA)
          case SS_CALL_MDL_COPY_RTP_DATA:
              if (ssGetmdlCopyRTPData(S) != NULL) {
                  ...
                  (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlCopyRTPData");
                  _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg) + 1);
              }
              break;
#         endif          
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_SETUP_RUNTIME_RESOURCES)
          case SS_CALL_MDL_SETUP_RUNTIME_RESOURCES:
            if (ssGetmdlSetupRuntimeResources(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSetupRuntimeResources");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_CLEANUP_RUNTIME_RESOURCES)
          case SS_CALL_MDL_CLEANUP_RUNTIME_RESOURCES:
            if (ssGetmdlCleanupRuntimeResources(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlCleanupRuntimeResources");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_INIT_SYSTEM_MATRICES)
	  case SS_CALL_MDL_INIT_SYSTEM_MATRICES:
            if (ssGetmdlInitSystemMatrices(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlInitSystemMatrices");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(RTW_GENERATED_ENABLE)
          case SS_CALL_RTW_GENERATED_ENABLE:
            if (ssGetRTWGeneratedEnable(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlEnable");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(RTW_GENERATED_DISABLE)
          case SS_CALL_RTW_GENERATED_DISABLE:
            if (ssGetRTWGeneratedDisable(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlDisable");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         endif
          ...
          case SS_CALL_MDL_CHECK_PARAMETERS:
            if (ssGetmdlCheckParameters(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlCheckParameters");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_PROCESS_PARAMETERS)
          case SS_CALL_MDL_PROCESS_PARAMETERS:
            if (ssGetmdlProcessParameters(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlProcessParameters");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_EXT_MODE_EXEC)
          case SS_CALL_MDL_EXT_MODE_EXEC:
            if (ssGetmdlExtModeExec(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlExtModeExec");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         elif defined(MDL_UPDATE)
          case SS_CALL_MDL_UPDATE:
            if (ssGetmdlUpdate(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlUpdate");
...
#         elif defined(MDL_DERIVATIVES)
          case SS_CALL_MDL_DERIVATIVES:
            if (ssGetmdlDerivatives(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlDerivatives");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_JACOBIAN)
	  case SS_CALL_MDL_JACOBIAN:
            if (ssGetmdlJacobian(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlJacobian");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_JACOBIANIRJC)
	  case SS_CALL_MDL_JACOBIANIRJC:
            if (ssGetmdlJacobianIrJc(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlJacobianIrJc");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_PROJECTION)
	  case SS_CALL_MDL_PROJECTION:
            if (ssGetmdlProjection(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlProjection");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_MASSMATRIX)
	  case SS_CALL_MDL_MASSMATRIX:
            if (ssGetmdlMassMatrix(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlMassMatrix");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_CONSTRAINTS)
	  case SS_CALL_MDL_CONSTRAINTS:
            if (ssGetmdlConstraints(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlConstraints");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_RTWCG)
	  case SS_CALL_MDL_RTWCG:
            if (ssGetmdlRTWCG(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlRTWCG");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
          ...
          case SS_CALL_MDL_GET_SIM_STATE:
            if (ssGetSimStateCompliance(S) != USE_CUSTOM_SIM_STATE) {
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE,
                              _SimstructErrmsgWithArg(
	  ...
	  case SS_CALL_MDL_SET_SIM_STATE:
            if (ssGetSimStateCompliance(S) != USE_CUSTOM_SIM_STATE) {
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg(
                                  "Simulink:SFunctions:SimStructUnexpectedFunctionCall",
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_SIM_STATUS_CHANGE)
          case SS_CALL_MDL_SIM_STATUS_CHANGE:
            if (ssGetmdlSimStatusChange(S) != NULL) {
                ...
                (void)_SS_SNPRINTF_1(errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlSimStatusChange");
                _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg)+1);
            }
            break;
#         endif
    ...
    const char* fcn)
{
    if (*idx < idxMin || *idx >= idxMaxPlus1) {
        if (ssGetErrorStatus((SimStruct*)S)==NULL) {  /* don't clobber an existing error */
            char_T errmsg[SS_ERROR_STATUS_BUFFER_SIZE];
            (void)_SS_SNPRINTF_6(
                errmsg, SS_ERROR_STATUS_BUFFER_SIZE, _SimstructErrmsgWithArg(
