...
void slSigLogAddTimeseriesDescription(SimStruct* sfcnS,
                                      ...
                                      const char_T* units);
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
void rtwGetLoggingIntervalFromSFBlock(void* pOpaqueSFBlock, void** outLoggingInterval);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
int_T slSigLogGetForEachDimsForRefModel(SimStruct* sfcnS, int_T*);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
void slmrRunPluginEvent(SimStruct* sfcnS, const char* modelName, const char* event);
#endif
