...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C CHAR16_T* rtwExcelLoaderGetUnicodeStringFromChars(
    const char* str);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C void rtwExcelLoaderFreeLabel(CHAR16_T* str);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C const char*
rtwExcelLoaderCreateInstanceWithSequenceSupport(const CHAR16_T* fileName,
...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C const char* rtwExcelLoaderGetOutput(
    void** outOutputValue,
    void* pExcelLoader,
    const double t,
