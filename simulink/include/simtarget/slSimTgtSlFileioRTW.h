...
const char* rtwMatFileLoaderCollectionCreateInstance(int errorXMLMode,
                                                     void** outMatFileLoaderCollection);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
const char* rtwMatFileLoaderCollectionAddElement(int errorXMLMode,
...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
const char* rtwMatFileLoaderCollectionGetOutput(int errorXMLMode,
                                                void* matFileLoaderCollection,
...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
const char* rtwMatFileLoaderCollectionDestroyInstance(int errorXMLMode,
                                                      void* matFileLoaderCollection);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
const char* rtwH5LoggingCollectionCreateInstance(int errorXMLMode,
                                                 void** outH5LoggingCollection,
                                                 void* intervalLogging);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
const char* rtwH5LoggingCollectionDestroyInstance(int errorXMLMode, void* h5LoggingCollection);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
const char* rtwH5LoggingCollectionAddElement(int errorXMLMode,
...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
const char* rtwMATFileLoaderCollectionGetZeroCrossingSignal(void* pMatFileLoaderCollection,
                                                            const size_t elementId,
                                                            const double t,
                                                            const int iMajorTimeStep,
...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
const char* rtwH5LoggingCollectionWrite(int errorXMLMode,
                                        void* h5LoggingCollection,
                                        const size_t elementId,
                                        const double t,
                                        const void* u);
...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C
const char* rtwSetMcosObjName(const char* fileName, int errorXMLMode, const char* objName);
