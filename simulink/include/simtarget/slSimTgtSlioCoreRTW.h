...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C void* rtwGetNewSlioCatalogue(
    const char* settingsFileName);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C void rtwTerminateSlioCatalogue(void** catalogue);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C void rtwSlioUpdateAccessor(void* accessor,
                                                                        const unsigned int portIdx,
                                                                        const double time,
                                                                        const void* dataPointer);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C void rtwSaveDatasetsToMatFile(void* catalogue,
                                                                           const char* fileName);
...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C void* rtwGetAccessor(const void* signalDescriptor,
...
rtwAddTopBusNode(const char* signalName, const unsigned int numberOfChildren, void* treeVector);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C void rtwAddBusNode(const char* signalName,
                                                                const unsigned int numberOfChildren,
                                                                void* treeVector);
...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C void rtwPopNVBusNode(void* treeVector);
...
SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C unsigned int rtwDisableStreamingToRepository(
    const void* catalogue);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C unsigned int rtwLogRootOutport(const void* catalogue);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C void* rt_SlioAccessorUpdate(int version,
                                                                         int nargs,
                                                                         ...);

SL_SIMTARGET_INSTRUMENTATION_EXPORT_EXTERN_C void* rt_SlioAccessorRelease(int version,
                                                                          int nargs,
                                                                          ...);
