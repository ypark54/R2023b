...
typedef enum { __slmsg_Except_Assertion_Failed = 0, __slmsg_Except_Bad_Alloc } __slmsg_Except_Type;

SL_MESSAGES_EXPORT_FCN_C void __slmsg_Except_raise(__slmsg_Except_Type eType,
                                                   const char_T* file,
                                                   int_T line);
...
SL_MESSAGES_EXPORT_FCN_C void* __slmsg_Mem_alloc(slMsgPoolSize nbytes,
                                                 const char_T* file,
                                                 int_T line);
SL_MESSAGES_EXPORT_FCN_C void* __slmsg_Mem_calloc(slMsgPoolSize count,
                                                  slMsgPoolSize nbytes,
                                                  const char_T* file,
                                                  int_T line);
SL_MESSAGES_EXPORT_FCN_C void __slmsg_Mem_free(void* ptr, const char_T* file, int_T line);
SL_MESSAGES_EXPORT_FCN_C void* __slmsg_Mem_resize(void* ptr,
                                                  slMsgPoolSize nbytes,
                                                  const char_T* file,
                                                  int_T line);

#define __slmsg_SYSTEM_ALLOC(nbytes) __slmsg_Mem_alloc((nbytes), __FILE__, __LINE__)
#define __slmsg_SYSTEM_CALLOC(count, nbytes) \
    __slmsg_Mem_calloc((count), (nbytes), __FILE__, __LINE__)
