 ...
 */
void akimaEvaluationViaHermiteBasis_float
(
    /* INPUTS:  */
...
)
{
    ...
    for (kk = 0; kk < numVq; ++kk) {
        ...
        Vq[kk] = akimaHermitePolynomialND_float(
                                                qq+strides[0],
                                                N,
                                                gridNumel,
                                                coefficients,
 ...
 *                 Must be \b pre-allocated.
 */
void akimaEvaluationViaHermiteBasis1D_float
(
    /* INPUTS:  */
    const float* x,
...
)
{
    ...
    for (kk = 0; kk < numVq; ++kk) {
        ...
        b = bq ? bq[kk] : akimaFindGridInterval1D_float(x,nx,xq[kk]);
 ...
 */
float akimaHermitePolynomialND_float
(
 ...
 */
MFL_INTERP_UINT akimaHermiteBasisND_float
(
    /* INPUTS:  */
 ...
 */
void akimaHermiteBasis1D_float
(
    /* INPUTS:  */
    const float* x,
    const MFL_INTERP_UINT        nx,
