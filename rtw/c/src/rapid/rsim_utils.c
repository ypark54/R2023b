                                         ...
                                         int           cellParamIndex)
{
    ...
    if ( mxIsCell(paParamStructs) ) {
        ...
        if (cellParamIndex > 0 && (size_t)cellParamIndex <= size){
                              ...
                              const PrmStructData *paramStructure)
{
    ...
    for (i=0; i<nTrans; i++) {
         ...
         */
        if ((dataType <= 13 && elSize != (size_t)dtSize) ||
...
/* Function: rt_RSimReadInportsMatFile ============================================
 *
 * Abstract:
 ...
 */
const char* rt_RSimReadInportsMatFile(const char* inportFileName,
                                      int* matFileFormat) {
